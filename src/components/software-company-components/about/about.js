            ...
            <div className="about_content">
              <div className="heading_block mb-0 text-white">
                ...
                <h2 className="heading_text">
                  Our Vision for <mark>The Future</mark>
                </h2>
                <p className="heading_description mb-0">
                  We envision a future where technology seamlessly integrates
                  with business needs. Our goal is to lead the charge in
                  innovation, providing solutions that enhance efficiency,
                  inspire creativity, and unlock new opportunities for growth.
                  Together, we will shape the future of success.
                </p>
              </div>
            </div>
          </div>
